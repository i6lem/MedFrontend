...
import { CartModel } from './topbar-doctor.model';
import { cartData } from './data';
import { NgbModal } from '@ng-bootstrap/ng-bootstrap';

@Component({
    selector: 'app-topbar-doctor',
    templateUrl: './topbar-doctor.component.html',
    standalone: false
})
export class TopbarDoctorComponent implements OnInit {
  messages: any
  element: any;
