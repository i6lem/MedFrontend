...
@Component({
    selector: 'app-two-column-sidebar-website',
    templateUrl: './two-column-sidebar-website.component.html',
    standalone: false
})
export class TwoColumnSidebarWebSiteComponent implements OnInit {
  menu: any;
  toggle: any = true;
  menuItems: MenuItem[] = [];
