...
@Component({
    selector: 'app-vertical-website',
    templateUrl: './verticalWebSite.component.html',
    styleUrls: ['./verticalWebSite.component.scss'],
    standalone: false
})
export class VerticalWebSiteComponent implements OnInit {
