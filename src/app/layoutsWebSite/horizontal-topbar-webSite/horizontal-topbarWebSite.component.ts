...
@Component({
    selector: 'app-horizontal-topbarWebSite',
    templateUrl: './horizontal-topbarWebSite.component.html',
    standalone: false
})
export class HorizontalTopbar_websiteComponent implements OnInit {
