...
@Component({
    selector: 'app-two-column-sidebar-patient',
    templateUrl: './two-column-sidebarPatient.component.html',
    standalone: false
})
export class TwoColumnSidebarPatientComponent implements OnInit {
  menu: any;
  toggle: any = true;
  menuItems: MenuItem[] = [];
