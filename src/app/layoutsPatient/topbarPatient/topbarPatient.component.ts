...
import { CartModel } from './topbarPatient.model';
import { cartData } from './data';
import { NgbModal } from '@ng-bootstrap/ng-bootstrap';

@Component({
    selector: 'app-topbar-patient',
    templateUrl: './topbarPatient.component.html',
    standalone: false
})
export class TopbarPatientComponent implements OnInit {
  messages: any
  element: any;
