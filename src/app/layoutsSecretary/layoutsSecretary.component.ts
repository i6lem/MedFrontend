...
@Component({
    selector: 'app-layout-secretary',
    templateUrl: './layoutsSecretary.component.html',
    styleUrls: ['./layoutsSecretary.component.scss'],
    standalone: false
})
 ...
 * Layout Component
 */
export class LayoutSecretaryComponent implements OnInit {
  layoutType!: string;
