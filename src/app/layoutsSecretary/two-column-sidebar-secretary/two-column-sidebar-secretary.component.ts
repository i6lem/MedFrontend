...
@Component({
    selector: 'app-two-column-sidebar-secretary',
    templateUrl: './two-column-sidebar-secretary.component.html',
    standalone: false
})
export class TwoColumnSidebarSecretaryComponent implements OnInit {
  menu: any;
  toggle: any = true;
  menuItems: MenuItem[] = [];
