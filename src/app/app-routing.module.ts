...
const routes: Routes = [
  ...
  { path: 'patient',component: LayoutPatientComponent , loadChildren: () => import('./components/componentsDashboard/componentDashPatient/componentsDashPatient.module').then(m => m.ComponentsDashUserModule)  },
  { path: 'doctor',component: LayoutDoctorComponent , loadChildren: () => import('./components/componentsDashboard/componentsDashDoctor/componentsDashDoctor.module').then(m => m.ComponentsDashEntrepriseModule )  },
