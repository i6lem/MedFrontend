...
@Component({
    selector: 'app-vertical-admin',
    templateUrl: './verticalAdmin.component.html',
    styleUrls: ['./verticalAdmin.component.scss'],
    standalone: false
})
export class VerticalAdminComponent implements OnInit {
